<%-- 
    ...
    Created on : 22 ก.ค. 2552, 22:42:28
    Author     : pop
--%>
...
function approveBillingLab(){
    ...
    <label><A HREF="#" NAME="anchor_audit" ID="anchor_audit">
        1. ตรวจข้อมูล<img src="images/printer-a.png" alt="" align="top" border="0"></A></label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label><A HREF="#" NAME="anchor_approve" ID="anchor_approve">
        2. อนุมัติข้อมูล<img src="images/printer-a.png" alt="" align="top" border="0"></A></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </th> </tr>
                    <tr><% } %>
                        <th >สาขา</th>
    ...
    <A HREF="#" NAME="anchor_set" ID="anchor_set">สร้าง&nbsp;<img src="images/navigate_check.gif" alt="" align="button" border="0"></A>&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;<label>หมายเหตุ&nbsp;<input type="text" name="txt_remark" id="txt_remark" value="<% out.print(abldb.abl.getBillLabRemark());%>" size="30"/></label></td>
                    </tr>
                    <tr>
                        <th>วันทำข้อมูล</th>
    ...
    <label>เลขที่นำเข้า<input type="text" size="10" name="txt_abl_id" id="txt_abl_id" value="<% out.print(abldb.abl.getBillLabId());%>" readonly /></label>
    &nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp; <A HREF="#" NAME="anchor_void" ID="anchor_void">
                ยกเลิกรายการนี้&nbsp;<img src="images/trash1.gif" alt="" align="top" border="0"></A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label><A HREF="#" NAME="anchor_print" ID="anchor_print">
        พิมพ์รายงาน<img src="images/printer-a.png" alt="" align="top" border="0"></A></label></td>
                    </tr>
...
<td ><input type="submit" name="submit" id="submit" value="Upload"> <input type="hidden" name="todo" id="todo" value="upload">
            ...
            <A HREF='#' NAME='anchor_save' ID='anchor_save'> บันทึกข้อมูล &nbsp;<img src='images/savedrafticon.gif' alt='' width='16' align='middle' height='16' border='0'></A><% } %>
                    ...
                    <% } %>
<tr ><th>รายละเอียด</th><td colspan="2">
                <label>ข้อมูลได้รับ&nbsp;<input type="text" name="txt_total_record_receive" id="txt_total_record_receive"
                value="<% out.print(config1.IntegerFormat(abldb.abl.getTotalRecordReceive().toString()));%>" size="6" readonly /></label>
&nbsp;<label>&nbsp;ข้อมูลอนุมัติ&nbsp;<input type="text" name="txt_total_record_approve" id="txt_total_record_approve"
             value="<% //out.print(total_record_approve);%>" size="4" readonly></label>
&nbsp;<label>&nbsp;ข้อมูลไม่อนุมัติ&nbsp;<input type="text" name="txt_total_record_unapprove" id="txt_total_record_unapprove"
             value="<% //out.print(total_record_unapprove);%>" size="4" readonly></label>
 &nbsp;&nbsp;&nbsp;&nbsp;<label>&nbsp;เงินวางบิล&nbsp;<input type="text" name="txt_total_amount_receive" id="txt_total_amount_receive"
             value="<% out.print(config1.NumberFormat(abldb.abl.getTotalAmountReceive()));%>" size="10" readonly></label>
    &nbsp;&nbsp;เงินอนุมัติ <input type="text" name="txt_total_amount_approve" id="txt_total_amount_approve"
           value="<% //out.print(total_amount_approve);%>" size="10" readonly/>
 &nbsp;<label>&nbsp;เงินไม่อนุมัติ <input type="text" name="txt_total_amount_unapprove" id="txt_total_amount_unapprove"
...
<div id="dialogVoid" title="ยกเลิกรายการ">
    <table widht="100%"><tr><th colspan="2" >ต้องการยกเลิกรายการนี้</th></tr>
        <tr>
            <th class="style14b">เลขที่นำเข้า</th><td><%out.print(abldb.abl.getBillLabId()); %></td>
      </tr>
    </table>
...
<div id="dialogAudit" title="ตรวจรายการ">
    <table widht="100%"><tr><th colspan="2" >ต้องการตรวจรายการ</th></tr>
        <tr>
            <th class="style14b">เลขที่นำเข้า</th><td><%out.print(abldb.abl.getBillLabId()); %></td>
      </tr>
    </table>
</div>
  <div id="dialogApprove" title="อนุมัติรายการ">
    <table widht="100%"><tr><th colspan="2" >ต้องการอนุมัติรายการ</th></tr>
        <tr>
            <th class="style14b">เลขที่นำเข้า</th><td><%out.print(abldb.abl.getBillLabId()); %></td>
      </tr>
    </table>
      ...
      <div id="dialogPrint">
        ...
        <tr><td class="style14b"><div align="left">
          <label><input type="radio" name="txt_report_name" value="lab_bill" id="rpt_billinglab_voucher"  >001 (ใบสั่งจ่าย lab)</label>
          <br><label><input type="radio" name="txt_report_name" value="lab_bill_item" id="rpt_billinglab" >002 (ใบบันทึกการจ่ายเงิน lab)</label>
          <br><br><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--<table border="0" width="720" align="center">
    <thead>
        <tr align="center" class='style14r'><td width="5" align="center">ลำดับที่</td>
            ...
            <td width="10">จำนวนผู้ป่วย</td>
            <td width="10">จำนวนรายการ</td>
            <td width="10">จำนวนเงินวางบิล</td>
            <td width="20">จำนวนที่ตรวจพบ</td>
            <td width="20">จำนวนที่ตรวจไม่พบ</td>
            <td width="10">จำนวนเงินอนุมัติ</td>
    </tr></thead>
    <tbody>
